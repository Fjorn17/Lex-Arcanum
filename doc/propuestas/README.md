...
86 candidatos. 43 salen del índice de *Ultimate Magic* de Pathfinder y están **reescritos de
cero** para este sistema; los otros 43 están escritos aquí, para llenar las Ramas que no tenían ningún
conjuro (Vapor, Incandescencia, Hongos) y las que no tenían ningún candidato (Gravedad, Espacio,
Tiempo). Marca los que quieras quedarte y dime; moverlos al catálogo es un paso mecánico
(está explicado abajo).

## Antes de nada, lo legal

El texto de Pathfinder es contenido abierto bajo la **OGL 1.0a**, y el sitio de donde sale el
índice está además bajo la *Community Use Policy* de Paizo, que **prohíbe expresamente cobrar
por el acceso**. Las dos cosas son licencias distintas de la CC BY 4.0 del SRD 5.2.1 que este
sitio ya usa.

Por eso aquí **no hay ni una línea de texto de Paizo**. Lo único que viene de allí es la idea
—y a varias les he cambiado el nombre además—; las reglas están escritas contra la página de
[cómo se escribe un conjuro](../../es/pages/astronomy/rules.html) y contra los números medidos
sobre nuestro propio catálogo. Aun así, si alguna te parece demasiado reconocible, dímelo y la
reescribo o la tiro.

## Qué se ha quedado fuera, y por qué

De los ~230 conjuros del índice, la mayor parte no pasa el filtro. Los motivos, agrupados:

| Motivo | Ejemplos |
| --- | --- |
| Invocar o crear una criatura | todo *Summon*, *Conjure Black Pudding*, *Rain of Frogs*, *Cape of Wasps*, *Simulacrum* |
| Necesita un sitio que no es este | *Create Demiplane* (los tres), *Interplanetary Teleport*, *Astral Projection* |
| Deshace una muerte, o la usa | *Temporary Resurrection*, *Animate Dead*, toda la familia *Undead Anatomy*, *Restore Corpse* |
| Autómatas y objetos mágicos | *Call Construct*, *Control Construct*, *Rapid Repair*, *Masterwork Transformation* |
| Alineamiento o favor divino | *Archon's Aura*, *Arrow of Law*, *Shard of Chaos*, *Unholy Sword*, *Spear of Purity* |
| Veneno, que ya está descatalogado aquí | *Pernicious Poison*, *Spit Venom*, *Toxic Gift*, *Epidemic*, *Plague Storm* |
| Contradice el sistema de frente | *Blood Transcription* (robar del cadáver de un mago un conjuro que sabía: el Repertorio **no se puede robar**, §5.9.7) |

Ese último es el que más me gusta como prueba de que el filtro funciona: es un conjuro
perfectamente jugable que este mundo no admite por una razón escrita.

## Cómo mover uno al catálogo

Cuando marques los que quieres, por cada uno hay que:

1. mover su bloque `== Nombre` de `propuestas/srd-en.txt` a `doc/spells/srd-en.txt`,
2. mover su bloque de `propuestas/es/01.txt` al `doc/spells/es/NN.txt` que le toque por orden,
3. copiar su línea de `propuestas/disciplinas.txt`, `subdisciplinas.txt` y `nombres-es.txt` a
   los ficheros de verdad,
4. y volver a generar. Las páginas HTML de aquí **no hay que moverlas**: se regeneran solas.

Lo hago yo de una tirada en cuanto me digas cuáles.
...
- [ ] **Escaldadura** · nivel 1 — Lo más barato que hace el vapor: llegar a un sitio que se le queda pequeño.  
      *Scald* · [ficha en inglés](en/scald.html) · [en español](es/scald.html)
- [ ] **Caldera** · nivel 4 — Vapor en sitio cerrado. Hace más daño bajo techo que al aire libre.  
      *Boiler* · [ficha en inglés](en/boiler.html) · [en español](es/boiler.html)
- [ ] **Bocanada** · nivel 6 — Línea de vapor a presión que empuja y deja el pasillo sin ver.  
...
- [ ] **Paso de plomo** · nivel 2 · concentración — Pesar el triple. Gravedad no tenía ningún candidato.  
      *Leaden Step* · [ficha en inglés](en/leaden-step.html) · [en español](es/leaden-step.html)
- [ ] **Pozo** · nivel 5 · concentración — El Abismo hecho pequeño y puesto en un sitio a propósito. Todo cae hacia ahí.  
      *Well* · [ficha en inglés](en/well.html) · [en español](es/well.html)
- [ ] **Abajo** · nivel 7 · concentración — Cambia hacia dónde es «abajo» dentro de un cubo de 40 pies.  
      *Downward* · [ficha en inglés](en/downward.html) · [en español](es/downward.html)
...
- [ ] **Frío que no se quita** · nivel 1 · concentración — Frío que no se quita y no deja descansar. Ningún fuego lo calienta.  
      *Unshakable Chill* · [ficha en inglés](en/unshakable-chill.html) · [en español](es/unshakable-chill.html)
- [ ] **Agonía aullante** · nivel 2 · concentración — Dolor sin causa: daño psíquico y media acción por turno.  
      *Howling Agony* · [ficha en inglés](en/howling-agony.html) · [en español](es/howling-agony.html)
- [ ] **Descoyuntar** · nivel 4 · concentración — El cuerpo sacado de sitio. Cualquier curación mágica lo termina.  
      *Wracking* · [ficha en inglés](en/wracking.html) · [en español](es/wracking.html)
- [ ] **La parada lenta** · nivel 6 · concentración — Coge el camino largo de todo lo que vive y lo hace corto.  
      *The Slow Stop* · [ficha en inglés](en/the-slow-stop.html) · [en español](es/the-slow-stop.html)
...
- [ ] **Bruma de duelos viejos** · nivel 3 · concentración — Bruma que no está. Cada uno ve la suya, y quien no tiene recuerdos no ve nada.  
      *Mist of Old Griefs* · [ficha en inglés](en/mist-of-old-griefs.html) · [en español](es/mist-of-old-griefs.html)

### Espiritismo › Vida

- [ ] **Aplacar la fiebre** · nivel 1 — Le devuelve al cuerpo los días que necesitaba, que es casi toda la medicina.  
      *Soothe the Fever* · [ficha en inglés](en/soothe-the-fever.html) · [en español](es/soothe-the-fever.html)
- [ ] **Diagnosticar el mal** · nivel 1 — Te dice qué tiene, y nada de cómo arreglarlo.  
      *Diagnose Illness* · [ficha en inglés](en/diagnose-illness.html) · [en español](es/diagnose-illness.html)
- [ ] **Aplazar el dolor** · nivel 2 — No cura: aplaza. Cuando termina llega todo junto como agotamiento.  
      *Delay Pain* · [ficha en inglés](en/delay-pain.html) · [en español](es/delay-pain.html)
- [ ] **Sobreponerse** · nivel 2 — Aparta un estado un rato y lo paga después.  
      *Shrug Off* · [ficha en inglés](en/shrug-off.html) · [en español](es/shrug-off.html)
- [ ] **Calentura** · nivel 3 · concentración — Asentar el pulso corrido del revés. Las escuelas los enseñan juntos.  
      *Fever* · [ficha en inglés](en/fever.html) · [en español](es/fever.html)
...
- [ ] **Estallido de ortigas** · nivel 2 — Ortigas que revientan el suelo alrededor.  
      *Burst of Nettles* · [ficha en inglés](en/burst-of-nettles.html) · [en español](es/burst-of-nettles.html)
- [ ] **Espesura** · nivel 2 — El uso más viejo del Brote no es un arma, es un techo.  
      *Thicket* · [ficha en inglés](en/thicket.html) · [en español](es/thicket.html)
- [ ] **Martillo de rama** · nivel 3 · concentración — A un árbol vinculado se le pide que mueva una rama muy deprisa.  
      *Bough Hammer* · [ficha en inglés](en/bough-hammer.html) · [en español](es/bough-hammer.html)
...
- [ ] **Robar la voz** · nivel 2 — Le quita la voz a alguien: no le quita la magia, le quita la manera fácil.  
      *Steal Voice* · [ficha en inglés](en/steal-voice.html) · [en español](es/steal-voice.html)
- [ ] **Ojos sin cuento** · nivel 3 · concentración — Ojos por toda la piel. No lo sorprenden, y no le compra nadie nada.  
      *Countless Eyes* · [ficha en inglés](en/countless-eyes.html) · [en español](es/countless-eyes.html)
- [ ] **Ecolocalización** · nivel 4 · concentración — Visión ciega a 60 pies. Se cae si te ensordecen.  
      *Echolocation* · [ficha en inglés](en/echolocation.html) · [en español](es/echolocation.html)
...
- [ ] **Fijación** · nivel 2 · concentración — Ve hasta eso y pon las manos encima. Pequeño y difícil de explicar después.  
      *Fixation* · [ficha en inglés](en/fixation.html) · [en español](es/fixation.html)
- [ ] **Serenidad** · nivel 3 · concentración — No puede hacer daño a nadie. Se rompe en cuanto alguien se lo hace a él.  
      *Serenity* · [ficha en inglés](en/serenity.html) · [en español](es/serenity.html)
- [ ] **Encaprichamiento** · nivel 4 · concentración — Encaprichado con otro durante una hora, y lo recuerda todo al terminar.  
      *Infatuation* · [ficha en inglés](en/infatuation.html) · [en español](es/infatuation.html)
- [ ] **Saña** · nivel 6 · concentración — Se le echa encima a quien nombres y no mira por dónde va.  
      *Outrage* · [ficha en inglés](en/outrage.html) · [en español](es/outrage.html)
...
tenía—, la Permuta —«lo más limpio que hace esta Disciplina»— y la Detención, con la llama que sigue
ardiendo mientras está parada.