...
},
{
  ...
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Senses, Emotions, Memory, Mental Control, Weariness',
              'Sentidos, Emociones, Memoria, Control Mental, Cansancio' ],
            [ 'Trade', 'Oficio', 'Mentalist', 'Mentalista' ] ],
  body => {
    en => ['<p>The widest Principle of the Discipline, and the one that holds the most of the supplement&rsquo;s catalogue. Five Branches: what a body perceives and what can be put into or taken out of that perception; what it feels, read or imposed; what it keeps of what it lived; what it decides and what it goes on to do; and what it has left to hold anything up with.</p>',
'<p>Illusion and Veil are one Branch and one pair: what is not there put in, and what is there taken out. Everything the supplement files as illusion lives here, because an illusion is not a thing made in the world &mdash; it is a thing made in a mind.</p>'],
    es => ['<p>El Principio m&aacute;s ancho de la Disciplina, y el que re&uacute;ne la mayor parte del cat&aacute;logo del suplemento. Cinco Ramas: lo que un cuerpo percibe y lo que puede pon&eacute;rsele o retir&aacute;rsele de la percepci&oacute;n; lo que siente, le&iacute;do o impuesto; lo que guarda de lo que vivi&oacute;; lo que decide y lo que llega a hacer; y lo que le queda para sostener algo.</p>',
'<p>Ilusi&oacute;n y Velo son una Rama y una pareja: lo que no est&aacute; puesto dentro, y lo que s&iacute; est&aacute; retirado. Todo lo que el suplemento clasifica como ilusi&oacute;n vive aqu&iacute;, porque una ilusi&oacute;n no es una cosa hecha en el mundo &mdash; es una cosa hecha en una mente.</p>'],
  },
  stars => [
    { en => 'Glimpse', es => 'Atisbo', branch => 'Senses / Sentidos',
      note => { en => 'Hands the caster what someone else is perceiving: what they see and hear, without touch or smell.',
                es => 'Entrega a quien canaliza lo que otro est&aacute; percibiendo: lo que ve y lo que oye, sin el tacto ni el olfato.' } },
    { en => 'Illusion', es => 'Ilusión', branch => 'Senses / Sentidos',
      note => { en => 'Puts into the senses of whoever receives it something that is not there.',
                es => 'Pone en los sentidos de quien la recibe algo que no est&aacute;.' } },
    { en => 'Veil', es => 'Velo', branch => 'Senses / Sentidos',
      note => { en => 'Takes out of the senses of whoever receives it something that is.',
                es => 'Retira de los sentidos de quien lo recibe algo que s&iacute; est&aacute;.' } },
    { en => 'Probing', es => 'Sondeo', branch => 'Emotions / Emociones',
      note => { en => 'Finds out what whoever receives it is feeling at that moment.',
                es => 'Averigua qu&eacute; siente quien la recibe en ese momento.' } },
    { en => 'Mood', es => 'Ánimo', branch => 'Emotions / Emociones',
      note => { en => 'Puts a feeling into whoever receives it: fear, calm, fury, attachment, apathy. It does not dictate acts, and that uncertainty is part of what is being used.',
                es => 'Pone un sentimiento en quien la recibe: miedo, calma, furia, apego, desgana. No dicta actos, y esa incertidumbre es parte de lo que se est&aacute; usando.' } },
    { en => 'Recall', es => 'Evocación', branch => 'Memory / Memoria',
      note => { en => 'Brings a particular memory of whoever receives it to the surface and hands it to the caster.',
                es => 'Trae a la superficie un recuerdo concreto de quien la recibe y lo entrega a quien canaliza.' } },
    { en => 'Imprint', es => 'Impronta', branch => 'Memory / Memoria',
      note => { en => 'Puts into whoever receives it a memory that never happened, or muddies one that did.',
                es => 'Pone en quien la recibe un recuerdo que no ocurri&oacute;, o enturbia uno que s&iacute;.' } },
    { en => 'Intent', es => 'Intención', branch => 'Mental Control / Control Mental',
      note => { en => 'Finds out what someone is about to do in the next instant.',
                es => 'Averigua qu&eacute; se dispone a hacer alguien en el instante siguiente.' } },
    { en => 'Compulsion', es => 'Sujeción', branch => 'Mental Control / Control Mental',
      note => { en => 'Imposes an act on whoever receives it.',
                es => 'Impone un acto a quien la recibe.' } },
    { en => 'Torpor', es => 'Sopor', branch => 'Mental Control / Control Mental',
      note => { en => 'Puts out the consciousness of whoever receives it.',
                es => 'Apaga la conciencia de quien lo recibe.' } },
    { en => 'Exhaustion', es => 'Extenuación', branch => 'Weariness / Cansancio',
      note => { en => 'Eats the Concentration of whoever receives it and piles Mental Fatigue on them, without touching the body.',
                es => 'Consume la Concentraci&oacute;n de quien la recibe y le acumula Fatiga Mental, sin tocarle el cuerpo.' } },
  ],
},
{
  ...
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Fauna, Flora', 'Fauna, Flora' ],
            [ 'Trade', 'Oficio', 'Druid', 'Druida' ] ],
  body => {
    en => ['<p>The Principle that is not imposed. A Pact is earned first, with dealings &mdash; shelter, food, defence, not failing &mdash; and the Star only acknowledges what already exists between the two. <b>A druid has companions, not tools</b>, and this Principle grants nothing over what has not been pacted.</p>',
'<p>It is also where the supplement files every spell that borrows a shape or a faculty from something alive, and everything that has to do with plants: what grows without moving from where it stands is Flora, not matter.</p>',
'<p>The one documented meeting between two Principles of this Discipline happens here: a beast that has been Pacted with offers no Opposition to the Stars of the Mind, because it has already accepted the arrangement.</p>'],
    es => ['<p>El Principio que no se impone. Un Pacto se gana antes, con trato &mdash; abrigo, comida, defensa, no fallar &mdash; y la Estrella &uacute;nicamente reconoce lo que ya existe entre los dos. <b>Un druida tiene compa&ntilde;eros, no herramientas</b>, y este Principio no le concede nada sobre lo que no ha pactado.</p>',
'<p>Es tambi&eacute;n donde el suplemento coloca todo conjuro que toma prestada una forma o una facultad de algo vivo, y cuanto tiene que ver con plantas: lo que crece sin moverse del sitio es Flora, no materia.</p>',
'<p>El &uacute;nico encuentro documentado entre dos Principios de esta Disciplina ocurre aqu&iacute;: una bestia con la que se ha sellado un Pacto no opone Resiliencia a las Estrellas de la Mente, porque ya ha admitido su trato.</p>'],
  },
  stars => [
    { en => 'Pact', es => 'Pacto', branch => 'Fauna / Fauna',
      note => { en => 'Seals the bond with an animal or a plant that will have it. Once sealed it holds itself without spending Ether, and takes up Concentration while it lasts.',
                es => 'Sella el v&iacute;nculo con un animal o una planta que lo admita. Una vez sellado se sostiene por s&iacute; solo sin gastar &Eacute;ter, y ocupa Concentraci&oacute;n mientras dure.' } },
    { en => 'Entreaty', es => 'Ruego', branch => 'Fauna / Fauna',
      note => { en => 'Passes to the bonded what is wanted of them, without words and as far as the Ether reaches. What arrives is the intent, not the order.',
                es => 'Transmite al vinculado lo que se quiere de &eacute;l, sin palabras y a la distancia que el &Eacute;ter alcance. Lo que llega es la intenci&oacute;n, no la orden.' } },
    { en => 'Loan', es => 'Préstamo', branch => 'Fauna / Fauna',
      note => { en => 'Borrows a faculty from the bonded and fits it into the caster&rsquo;s body: the wolf&rsquo;s nose, the hawk&rsquo;s eye, the ox&rsquo;s endurance, the fish&rsquo;s breath.',
                es => 'Toma prestada una facultad del vinculado y la instala en el cuerpo de quien canaliza: el olfato del lobo, la vista del halc&oacute;n, el aguante del buey, el aliento del pez.' } },
    { en => 'Shifting', es => 'Mudanza', branch => 'Fauna / Fauna',
      note => { en => 'Takes the bonded creature&rsquo;s whole form.',
                es => 'Toma la forma entera del vinculado.' } },
    { en => 'Sprouting', es => 'Brote', branch => 'Flora / Flora',
      note => { en => 'Governs the growing of a bonded plant: roots that shift, branches that close over a way, a harvest that runs weeks ahead in one night.',
                es => 'Gobierna el crecer de una planta vinculada: ra&iacute;ces que se desplazan, ramas que se cierran sobre un paso, una cosecha que adelanta semanas en una noche.' } },
  ],
},
{
  ...
  body => {
    en => ['<p>What repairs in minutes what a body would repair by itself in weeks, and what drives out of a body whatever is consuming it. It is the shortest Principle of the Discipline and the least ambiguous: everything it does, a body could in principle have done alone, given time it does not have.</p>',
'<p>Its ceiling is the death rule. Once the soul has scattered there is nothing left to work on, so this Principle stops exactly where the Principle of Death begins &mdash; and neither of the two crosses back.</p>'],
    es => ['<p>Lo que repara en minutos cuanto el cuerpo reparar&iacute;a por s&iacute; solo con semanas, y lo que expulsa de un cuerpo aquello que lo est&aacute; consumiendo. Es el Principio m&aacute;s corto de la Disciplina y el menos ambiguo: todo lo que hace podr&iacute;a en principio haberlo hecho el cuerpo solo, con un tiempo del que no dispone.</p>',
'<p>Su techo es la regla de la muerte. Repartida el alma no queda nada sobre lo que trabajar, as&iacute; que este Principio se detiene exactamente donde empieza el de la Muerte &mdash; y ninguno de los dos cruza de vuelta.</p>'],
  ...
  stars => [
    { en => 'Suture', es => 'Sutura', branch => 'Healing / Sanación',
      note => { en => 'Closes what is open: skin, flesh, vessel.', es => 'Cierra lo abierto: piel, carne, vaso.' } },
    { en => 'Knitting', es => 'Trabazón', branch => 'Healing / Sanación',
      note => { en => 'Joins back what is broken: bone, tendon, cartilage.',
                es => 'Vuelve a unir lo quebrado: hueso, tend&oacute;n, cart&iacute;lago.' } },
    { en => 'Replenishment', es => 'Reposición', branch => 'Healing / Sanación',
      note => { en => 'Remakes what a body is missing: the blood spilled, the flesh torn away, the limb lost.',
                es => 'Rehace lo que a un cuerpo le falta: la sangre derramada, la carne arrancada, el miembro perdido.' } },
    { en => 'Purge', es => 'Purga', branch => 'Cleansing / Purificación',
      note => { en => 'Drives out of a body the poison or the sickness consuming it.',
                es => 'Expulsa de un cuerpo el veneno o el mal que lo consume.' } },
  ],
},
{
  ...
  body => {
    en => ['<p>The Principle that is hunted almost everywhere, and the reason a necromancer rarely says out loud what they do. What it is hunted for is March: <b>what is raised moves because the Ether moves it, and there is nobody inside.</b> It does not remember, it does not obey beyond whatever is being imposed on it that instant, and it is not who it was.</p>',
'<p>Threshold is the whole of what this Discipline can do about death itself, and it is very little: it reaches a soul just gone, in the instant between the death and its scattering into the Ether. After that instant there is nothing to reach. <b>No Star of this Principle, or of any other, brings anyone back</b> &mdash; and every spell that claimed to has been struck from the supplement&rsquo;s catalogue.</p>',
'<p>Necrosis is the exception that faces the other way: the only Star here that works on someone still alive, and the exact counterpart of everything the Principle of Life does. In many places the word <i>necromancer</i> and the word <i>poison</i> are used as if they meant the same.</p>'],
    es => ['<p>El Principio que se persigue en casi todo el mundo conocido, y el motivo de que un nigromante rara vez diga en voz alta a qu&eacute; se dedica. Se le persigue por Marcha: <b>lo que se levanta se mueve porque el &Eacute;ter lo mueve, y dentro no hay nadie.</b> No recuerda, no obedece m&aacute;s de lo que se le est&eacute; imponiendo en ese instante y no es quien fue.</p>',
'<p>Umbral es todo lo que esta Disciplina puede hacer con la muerte misma, y es muy poco: alcanza un alma reci&eacute;n ida, en el instante que media entre la muerte y su reparto en el &Eacute;ter. Pasado ese instante no queda nada que alcanzar. <b>Ninguna Estrella de este Principio, ni de ning&uacute;n otro, devuelve a nadie</b> &mdash; y todo conjuro que dec&iacute;a hacerlo ha salido del cat&aacute;logo del suplemento.</p>',
'<p>Necrosis es la excepci&oacute;n que mira al otro lado: la &uacute;nica Estrella de aqu&iacute; que trabaja sobre alguien que sigue vivo, y la contraparte exacta de cuanto hace el Principio de Vida. En muchos sitios la palabra <i>nigromante</i> y la palabra <i>veneno</i> se usan como si dijeran lo mismo.</p>'],
  },
  stars => [
    { en => 'Threshold', es => 'Umbral', branch => 'Soul / Ánima',
      note => { en => 'Reaches a soul just gone, in the instant between death and its scattering into the Ether.',
                es => 'Alcanza un alma reci&eacute;n ida, en el instante que media entre la muerte y su reparto en el &Eacute;ter.' } },
    { en => 'Severing', es => 'Desprendimiento', branch => 'Soul / Ánima',
      note => { en => 'Takes the caster&rsquo;s own soul out of the body.',
                es => 'Saca del cuerpo la propia alma.' } },
    { en => 'March', es => 'Marcha', branch => 'Soul / Ánima',
      note => { en => 'Makes a body that stopped living move. Nobody is inside it.',
                es => 'Hace que un cuerpo que dej&oacute; de vivir se mueva. Dentro no hay nadie.' } },
    { en => 'Necrosis', es => 'Necrosis', branch => 'Sickness / Enfermedad',
      note => { en => 'Rots the living tissue of a body: the flesh, the organ, the bone. What it reaches carries on rotting on its own until someone stops it.',
                es => 'Corrompe el tejido vivo de un cuerpo: la carne, el &oacute;rgano, el hueso. Lo alcanzado sigue por su cuenta mientras nadie lo ataje.' } },
  ],
},
...
{
  key => 'tempo', kind => 'sub', parent => 'cosmology',
  name => { en => 'Tempo', es => 'Ritmo' },
  lead => { en => 'The passing of time over what is happening', es => 'El paso del tiempo sobre lo que est&aacute; ocurriendo' },
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Quickening, Slowing, Halting', 'Aceleraci&oacute;n, Ralentizaci&oacute;n, Detenci&oacute;n' ] ],
  body => {
    en => ['<p>Three Branches and one axis: what it reaches happens sooner than it would, later than it would, or stops happening for as long as the channelling lasts. Each of the first two has a Star for movement and a Star for the processes a body carries inside, and the second of each pair is the quieter and the more useful: blood that stops running from a wound, mortar that sets in an afternoon.</p>',
'<p>Suspension is the most expensive Star of the Discipline after the two of the Past, and against something alive it resolves like any other contest of Resilience. What is suspended does not move, fall, burn or bleed, and stays exactly where it was &mdash; a flame held halfway down is still burning, and catches whatever touches it the instant the channelling fails.</p>'],
    es => ['<p>Tres Ramas y un solo eje: cuanto alcanza ocurre antes de lo que ocurrir&iacute;a, despu&eacute;s de lo que ocurrir&iacute;a, o deja de ocurrir mientras dure la canalizaci&oacute;n. Cada una de las dos primeras tiene una Estrella para el movimiento y otra para los procesos que un cuerpo lleva dentro, y la segunda de cada pareja es la m&aacute;s callada y la m&aacute;s &uacute;til: sangre que deja de correr por una herida, argamasa que fragua en una tarde.</p>',
'<p>Suspensi&oacute;n es la Estrella m&aacute;s cara de la Disciplina despu&eacute;s de las dos del Pasado, y contra alguien vivo se resuelve como cualquier contienda de Resiliencia. Lo detenido no se mueve, no cae, no arde y no sangra, y sigue exactamente donde estaba: una llama suspendida a media ca&iacute;da sigue ardiendo en el aire y prende cuanto la toque en el instante en que la canalizaci&oacute;n falle.</p>'],
  },
  stars => [
    { en => 'Urging', es => 'Apremio', branch => 'Quickening / Aceleración',
      note => { en => 'Speeds the movement and the reaction of a body.',
                es => 'Acelera el movimiento y la reacci&oacute;n de un cuerpo.' } },
    { en => 'Course', es => 'Curso', branch => 'Quickening / Aceleración',
      note => { en => 'Speeds the processes a body carries inside: iron rusts, fruit ripens and rots, mortar sets, a wound closes.',
                es => 'Acelera los procesos que un cuerpo lleva dentro: el hierro se oxida, la fruta madura y se pudre, la argamasa fragua, la herida cicatriza.' } },
    { en => 'Drag', es => 'Rémora', branch => 'Slowing / Ralentización',
      note => { en => 'Slows the movement and the reaction of a body.',
                es => 'Frena el movimiento y la reacci&oacute;n de un cuerpo.' } },
    { en => 'Lethargy', es => 'Letargo', branch => 'Slowing / Ralentización',
      note => { en => 'Slows the processes a body carries inside: blood stops running from a wound, poison stops advancing, flesh does not rot and bread does not go stale.',
                es => 'Frena los procesos que un cuerpo lleva dentro: la sangre deja de correr por una herida, el veneno deja de avanzar, la carne no se pudre y el pan no se seca.' } },
    { en => 'Suspension', es => 'Suspensión', branch => 'Halting / Detención',
      note => { en => 'Stops the passing of time entirely over whatever it reaches.',
                es => 'Detiene por completo el paso del tiempo sobre lo que alcanza.' } },
  ],
},
{
  key => 'age', kind => 'sub', parent => 'cosmology',
  name => { en => 'Age', es => 'Edad' },
  lead => { en => 'The time piled up in a body', es => 'El tiempo acumulado en un cuerpo' },
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Old Age, Youth', 'Vejez, Juventud' ] ],
  body => {
    en => ['<p>The narrowest Principle of the Discipline: two Stars and two Branches, one that loads years onto a body and one that takes them off. Where Tempo works on the rate at which something happens, Age works on the total already spent.</p>',
'<p><b>No spell of the supplement lives here.</b> Nothing in the catalogue adds or removes years, so the Principle stands documented and empty &mdash; which is worth saying, because the emptiness is a fact about the catalogue and not about the art.</p>'],
    es => ['<p>El Principio m&aacute;s estrecho de la Disciplina: dos Estrellas y dos Ramas, una que carga a&ntilde;os sobre un cuerpo y otra que se los quita. Donde Ritmo trabaja sobre el ritmo al que ocurre algo, Edad trabaja sobre el total ya gastado.</p>',
'<p><b>Ning&uacute;n conjuro del suplemento vive aqu&iacute;.</b> Nada del cat&aacute;logo a&ntilde;ade ni retira a&ntilde;os, de modo que el Principio queda documentado y vac&iacute;o &mdash; lo cual conviene decir, porque el vac&iacute;o es un dato sobre el cat&aacute;logo y no sobre el arte.</p>'],
  },
  stars => [
    { en => 'Senescence', es => 'Senescencia', branch => 'Old Age / Vejez',
      note => { en => 'Loads the body it reaches with years.', es => 'Carga de a&ntilde;os el cuerpo que alcanza.' } },
    { en => 'Greening', es => 'Verdor', branch => 'Youth / Juventud',
      note => { en => 'Takes years off the body it reaches.', es => 'Retira a&ntilde;os del cuerpo que alcanza.' } },
  ],
},
{
  key => 'past', kind => 'sub', parent => 'cosmology',
  name => { en => 'Past', es => 'Pasado' },
  lead => { en => 'What already happened, in matter and in memory',
            es => 'Lo que ya ocurri&oacute;, en la materia y en la memoria' },
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Reversion, Return', 'Reversi&oacute;n, Regreso' ] ],
  body => {
    en => ['<p>The two most expensive Stars in the Discipline. Reversion works on matter: the broken sword comes back whole, the burnt door comes back sound, the fallen wall stands up with the stones it had. Return works on the caster: it sends their consciousness into their own body as it was at an earlier moment, with everything they know now.</p>',
'<p>The treatise notes, without explaining it, that looking backwards comes out far cheaper than looking forwards &mdash; and since the forward half of the Discipline has been struck out entirely, the asymmetry has stopped being a puzzle and become the rule.</p>'],
    es => ['<p>Las dos Estrellas m&aacute;s caras de la Disciplina. Reversi&oacute;n trabaja sobre la materia: la espada rota vuelve entera, la puerta quemada vuelve sana, el muro derrumbado se levanta con las piedras que ten&iacute;a. Regreso trabaja sobre quien traza: env&iacute;a su conciencia a su propio cuerpo tal como era en un momento anterior, con cuanto sabe ahora.</p>',
'<p>El tratado se&ntilde;ala, sin explicarlo, que mirar atr&aacute;s sale mucho m&aacute;s barato que mirar adelante &mdash; y como la mitad de adelante de la Disciplina ha quedado tachada del todo, la asimetr&iacute;a ha dejado de ser un enigma para ser la regla.</p>'],
  },
  stars => [
    { en => 'Reversion', es => 'Vuelta', branch => 'Reversion / Reversión',
      note => { en => 'Puts an inert body back into a state it once had.',
                es => 'Devuelve un cuerpo inerte a un estado anterior suyo.' } },
    { en => 'Ascent', es => 'Remonte', branch => 'Return / Regreso',
      note => { en => 'Sends the caster&rsquo;s consciousness into their own body as it was at an earlier moment, with everything they know now.',
                es => 'Env&iacute;a la conciencia de quien la traza a su propio cuerpo tal como era en un momento anterior, con cuanto sabe ahora.' } },
  ],
},
{
  key => 'passage', kind => 'sub', parent => 'cosmology',
  name => { en => 'Passage', es => 'Paso' },
  lead => { en => 'Two points of the world set side by side',
            es => 'Dos puntos del mundo puestos uno junto a otro' },
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Portal', 'Portal' ] ],
  body => {
    en => ['<p>The Principle of distance annulled. One Star, one Branch, and the largest share of the supplement&rsquo;s catalogue of any subdivision of this Discipline.</p>',
'<p><b>Seeing at a distance counts here.</b> A remote sensor is two points of the world set side by side, which is exactly what this Principle does; it simply sends sight across instead of a body. Finding something far off is the same operation with nothing sent at all.</p>',
'<p>Its second Branch, <b>Pocket</b>, has been struck out: it made a closed space that is nowhere, and there is no space apart from this one. What is left is a way from here to there, open only for as long as somebody keeps feeding it.</p>'],
    es => ['<p>El Principio de la distancia anulada. Una Estrella, una Rama, y la mayor parte del cat&aacute;logo del suplemento entre todas las subdivisiones de esta Disciplina.</p>',
'<p><b>Ver a distancia cuenta aqu&iacute;.</b> Un sensor remoto son dos puntos del mundo puestos uno junto a otro, que es exactamente lo que hace este Principio; solo que manda la vista en lugar de un cuerpo. Encontrar algo lejano es la misma operaci&oacute;n sin mandar nada.</p>',
'<p>Su segunda Rama, <b>Bolsillo</b>, ha quedado tachada: formaba un espacio cerrado que no est&aacute; en ninguna parte, y no hay m&aacute;s espacio que este. Lo que queda es un camino de aqu&iacute; a all&iacute;, abierto solo mientras alguien lo alimente.</p>'],
  },
  stars => [
    { en => 'Opening', es => 'Vano', branch => 'Portal / Portal',
      note => { en => 'Opens a way between the place it is traced and another point, and whatever crosses it appears on the far side.',
                es => 'Abre un paso entre el sitio donde se traza y otro punto, y cuanto lo cruce aparece al otro lado.' } },
  ],
},
{
  key => 'presage', kind => 'sub', parent => 'cosmology',
  name => { en => 'Presage', es => 'Porvenir' },
  lead => { en => 'What has not happened yet, as it would go if nobody looked',
            es => 'Lo que a&uacute;n no ha ocurrido, tal como se comportar&iacute;a si nadie lo mirara' },
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Glimpse', 'Vislumbre' ] ],
  body => {
    en => ['<p>The narrowest Principle of the art, and the one that comes closest to a thing this world does not allow. <b>It does not read the future.</b> Nothing has written the future down, so there is nothing there to read &mdash; and every spell that claimed to ask a god what was coming has been struck from the catalogue.</p>',
'<p>What it does instead is smaller and defensible: it shows a <b>probable outcome of what is already in motion</b>. The stone is already falling; where it lands is not prophecy, it is arithmetic done faster than a body can do it. That is the whole Principle, and it is why it holds two spells and not twenty.</p>',
'<p>Its own treatise called it the poorest part of the Discipline and taught the imbalance as a fact rather than an oversight. Looking backwards comes out far cheaper than looking forwards, and no school has ever explained why.</p>'],
    es => ['<p>El Principio m&aacute;s estrecho del arte, y el que m&aacute;s se acerca a algo que este mundo no permite. <b>No lee el futuro.</b> Nadie ha escrito el futuro, as&iacute; que no hay nada ah&iacute; que leer &mdash; y todo conjuro que dec&iacute;a preguntarle a un dios qu&eacute; ven&iacute;a ha salido del cat&aacute;logo.</p>',
'<p>Lo que hace en su lugar es m&aacute;s peque&ntilde;o y defendible: muestra un <b>desenlace probable de lo que ya est&aacute; en marcha</b>. La piedra ya est&aacute; cayendo; d&oacute;nde aterriza no es profec&iacute;a, es una cuenta hecha m&aacute;s deprisa de lo que un cuerpo la hace. Ese es el Principio entero, y por eso tiene dos conjuros y no veinte.</p>',
'<p>Su propio tratado lo llamaba la parte m&aacute;s pobre de la Disciplina y ense&ntilde;aba la desproporci&oacute;n como un dato y no como un descuido. Mirar atr&aacute;s sale mucho m&aacute;s barato que mirar adelante, y ninguna escuela ha explicado nunca por qu&eacute;.</p>'],
  },
  stars => [
    { en => 'Glimpse', es => 'Vislumbre', branch => 'Glimpse / Vislumbre',
      note => { en => 'Shows the caster a probable outcome of what is already under way.',
                es => 'Muestra a quien la traza un desenlace probable de lo que ya est&aacute; en marcha.' } },
  ],
},
{
  key => 'distortion', kind => 'sub', parent => 'cosmology',
  name => { en => 'Distortion', es => 'Distorsión' },
  lead => { en => 'The size, the arrangement and the position of a body',
            es => 'El tama&ntilde;o, la disposici&oacute;n y la posici&oacute;n de un cuerpo' },
  info => [ [ 'Class', 'Clase', 'Principle', 'Principio' ],
            [ 'Branches', 'Ramas', 'Size, Separation, Exchange', 'Tama&ntilde;o, Separaci&oacute;n, Intercambio' ] ],
  body => {
    en => ['<p>Three Branches and three Stars, one each: how much room a body takes up, its parts held apart without ceasing to be joined, and two bodies changing places.</p>',
'<p>Swap is the cleanest thing this Discipline does. The Ether measures only the distance between the two bodies &mdash; it makes no difference what they are, what they weigh or how unalike they are, so exchanging a man for a stone costs the same as exchanging two men. It never reaches the living pulse, so there is no Resilience to set against it: <b>the only thing that dodges it is not being where the astronomer thought you were</b>, which is why whoever fears this Principle learns to move before they learn to resist.</p>'],
    es => ['<p>Tres Ramas y tres Estrellas, una cada una: cu&aacute;nto ocupa un cuerpo, sus partes apartadas sin dejar de estar unidas, y dos cuerpos que cambian de sitio.</p>',
'<p>Permuta es lo m&aacute;s limpio que hace esta Disciplina. El &Eacute;ter mide &uacute;nicamente la distancia que separa a los dos cuerpos &mdash; da igual qu&eacute; sean, cu&aacute;nto pesen o cu&aacute;nto se diferencien, de modo que cambiar a un hombre por una piedra cuesta lo mismo que cambiar a dos hombres entre s&iacute;. No alcanza el pulso vital y por tanto no hay Resiliencia que oponerle: <b>lo &uacute;nico que la esquiva es no estar donde el astr&oacute;nomo cre&iacute;a que se estaba</b>, y de ah&iacute; que quien teme a este Principio aprenda antes a moverse que a resistir.</p>'],
  },
  stars => [
    { en => 'Scale', es => 'Escala', branch => 'Size / Tamaño',
      note => { en => 'Changes the size of a body.', es => 'Cambia el tama&ntilde;o de un cuerpo.' } },
    { en => 'Cleaving', es => 'Escisión', branch => 'Separation / Separación',
      note => { en => 'Parts the pieces of a body from one another without breaking what joins them.',
                es => 'Aparta unas de otras las partes de un cuerpo sin romper lo que las une.' } },
    { en => 'Swap', es => 'Permuta', branch => 'Exchange / Intercambio',
      note => { en => 'Exchanges the positions of two bodies. The Ether measures only the distance between them.',
                es => 'Intercambia la posici&oacute;n de dos cuerpos. El &Eacute;ter mide &uacute;nicamente la distancia que los separa.' } },
  ],
},
{
  ...
  body => {
    en => ['<p>Two Branches, and the difference between them is who is being answered. Weight works on one body: how hard what is underneath pulls on it. Field works on a stretch of the world: which way everything inside it falls, or towards which single point.</p>',
'<p>The Well is the Principle at its own threshold &mdash; the Abyss made small and put somewhere on purpose. It is where this Discipline most obviously imitates what it is named after, and the one Star of the three Disciplines that is a base state pointed outwards.</p>'],
    es => ['<p>Dos Ramas, y la diferencia entre ellas es a qui&eacute;n se le responde. Peso trabaja sobre un cuerpo: cu&aacute;nto tira de &eacute;l lo que hay debajo. Campo trabaja sobre una extensi&oacute;n del mundo: hacia d&oacute;nde cae cuanto haya dentro, o hacia qu&eacute; punto &uacute;nico.</p>',
'<p>El Pozo es el Principio puesto en su propio umbral &mdash; el Abismo hecho peque&ntilde;o y colocado en alg&uacute;n sitio a prop&oacute;sito. Es donde esta Disciplina imita m&aacute;s a las claras aquello de lo que toma el nombre, y la &uacute;nica Estrella de las tres Disciplinas que es un estado base apuntando hacia fuera.</p>'],
  },
  stars => [
    { en => 'Ballast', es => 'Lastre', branch => 'Weight / Peso',
      note => { en => 'Raises the weight of a body without changing its size.',
                es => 'Aumenta el peso de un cuerpo sin cambiar su tama&ntilde;o.' } },
    { en => 'Lightness', es => 'Levedad', branch => 'Weight / Peso',
      note => { en => 'Lowers the weight of a body until it floats.',
                es => 'Reduce el peso de un cuerpo hasta hacerlo flotar.' } },
    { en => 'Slant', es => 'Sesgo', branch => 'Field / Campo',
      note => { en => 'Changes the direction in which everything within its reach falls.',
                es => 'Cambia la direcci&oacute;n hacia la que cae cuanto entra en la extensi&oacute;n alcanzada.' } },
    { en => 'Well', es => 'Pozo', branch => 'Field / Campo',
      note => { en => 'Draws the falling of everything around it towards a single point.',
                es => 'Concentra hacia un punto la ca&iacute;da de cuanto lo rodea.' } },
  ],
},
